...
- [type AuthConfigProvider](<#AuthConfigProvider>)
- [type Claims](<#Claims>)
- [type Decoder](<#Decoder>)
  - [func NewDecoder\(provider AuthConfigProvider\) \*Decoder](<#NewDecoder>)
  ...
  - [func \(d \*Decoder\) ReplaceProvider\(provider AuthConfigProvider\) error](<#Decoder.ReplaceProvider>)
