...
- [type Manager](<#Manager>)
  ...
  - [func \(m \*Manager\) Register\(settings Settings, host, port string\) error](<#Manager.Register>)
...
- [type Store](<#Store>)
  ...
  - [func \(s \*Store\) Apply\(settings config.Settings, \_, \_ string\) error](<#Store.Apply>)
...
- [type Store](<#Store>)
  - [func NewStore\(\) \*Store](<#NewStore>)
  - [func \(s \*Store\) Apply\(settings internalconfig.Settings, \_, \_ string\) error](<#Store.Apply>)
...
- [type Store](<#Store>)
  - [func NewStore\(\) \*Store](<#NewStore>)
  - [func \(s \*Store\) Apply\(settings internalconfig.Settings, host, port string\) error](<#Store.Apply>)
  ...
  - [func \(s \*Store\) ServiceFor\(serviceName string\) \(internalconfig.ServiceSettings, bool\)](<#Store.ServiceFor>)
